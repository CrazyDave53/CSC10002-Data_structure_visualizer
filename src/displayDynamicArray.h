#ifndef CSC10002_DATA_STRUCTURE_VISUALIZER_DISPLAYDYNAMICARRAY_H
#define CSC10002_DATA_STRUCTURE_VISUALIZER_DISPLAYDYNAMICARRAY_H
...
class displayDynamicArray{
public:
    displayDynamicArray(sf::RenderWindow& window);
    ~displayDynamicArray();
...
private:
    ...
    gui::TextBox* inputAllocateSize;
    gui::Button* goAllocate;
...
#endif //CSC10002_DATA_STRUCTURE_VISUALIZER_DISPLAYDYNAMICARRAY_H
